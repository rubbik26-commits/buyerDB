...
export default function App() {
  ...
  const Active = TABS.find((t) => t.id === tab)?.C || Workbench;
  const s = meta?.stats;
        ...
        {err && (
          <div className="content">
            <div className="banner err">
              API connection issue at <code>{api.base}</code>. The app shell will stay open instead of blanking. — {String(err.message || err)}
            </div>
          </div>
        )}
